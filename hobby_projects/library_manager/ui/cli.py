...
from utils.exceptions import QuitException
...
class CLI:
    ...
    def search_books(self):
        querry = input("Enter the name of the title or name of the author or isbn number to search: ")
        search = self.library.search_books(querry)
        if search:
